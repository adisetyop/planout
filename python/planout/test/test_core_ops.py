...
class TestBasicOperators(unittest.TestCase):
    ...
    def test_seq(self):
        ...
        self.assertEqual({'x': 'x_val', 'y': 'y_val'}, d)
    ...
    def test_cond(self):
        ...
        self.assertEqual({'x': 'x_0'}, testIf(0))
        self.assertEqual({'x': 'x_1'}, testIf(1))
    ...
    def test_get(self):
        ...
        self.assertEqual({'x': 'x_val', 'y': 'x_val'}, d)
    ...
    def test_length(self):
        ...
        self.assertEqual(len(arr), length_test)
        length_test = self.run_config_single({'op': 'length', 'value': []})
        self.assertEqual(0, length_test)
        length_test = self.run_config_single({'op': 'length', 'value':
                                              {'op': 'array', 'values': arr}
                                              })
        self.assertEqual(length_test, len(arr))
    ...
    def test_return(self):
        ...
        self.assertEqual({'x': 2}, i.get_params())
        self.assertEqual(True, i.in_experiment)
        i = return_runner(42)
        self.assertEqual({'x': 2}, i.get_params())
        self.assertEqual(True, i.in_experiment)
        i = return_runner(False)
        self.assertEqual({'x': 2}, i.get_params())
        self.assertEqual(False, i.in_experiment)
        i = return_runner(0)
        self.assertEqual({'x': 2}, i.get_params())
        self.assertEqual(False, i.in_experiment)
